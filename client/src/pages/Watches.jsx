...
const MOCK_WATCHES = [
  { id: 3, name: 'Chrono Chronograph V2', category: 'Watches', price: 1150, tag: 'Premium Tier', image: 'https://images.unsplash.com/photo-1523275335684-37898b6baf30?q=80&w=600&auto=format&fit=crop', specs: 'Titanium Shell / Sapphire Glass' }
]
        ...
        <div className="max-w-7xl mx-auto relative z-10 mt-6">
          <div className="space-y-4 mb-12 text-left border-b border-white/5 pb-8">
              <div className="inline-flex items-center gap-2 text-[10px] font-black tracking-[0.3em] uppercase bg-white/5 border border-white/10 px-4 py-1.5 rounded-full text-lime-accent">
                <Sparkles className="w-3 h-3" /> Horology Timepieces
              </div>
              <h1 className="text-4xl md:text-6xl font-black uppercase tracking-wider">Watches <span className="text-lime-accent font-light">Vault</span></h1>
          </div>
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-start">
            <div className="lg:col-span-3 lg:sticky lg:top-28 lg:max-h-[calc(100vh-160px)] lg:overflow-y-auto space-y-8 bg-white/[0.02] border border-white/5 rounded-2xl p-6 backdrop-blur-md custom-scrollbar text-left">
              ...
              <div className="space-y-3">
                ...
                <input type="range" min="500" max="2000" step="50" value={maxPrice} onChange={(e) => setMaxPrice(Number(e.target.value))} className="w-full accent-lime-accent bg-white/10 h-1 rounded-lg" />
              </div>
              <div className="space-y-2">
