...
const Login = () => {
  ...
  const handleMouseMove = (e) => {
    ...
    // Calculate dynamic tilt angles (Max 15 degrees tilt for structural premium look)
    setRotateY(rotateYVal * 15);
    setRotateX(-rotateXVal * 15);

    // Track light flare placement inside card surface
  ...
  // Return card structural axis to perfect balance when mouse exits frame
  ...
  const handleSubmit = (e) => {
    ...
    setTimeout(() => {
      ...
      console.log("3D Node Authorized.", formData);
    }, 2000);
  };
  ...
  return (
    <div className="min-h-screen bg-[#071640] text-white flex items-center justify-center p-4 relative overflow-hidden select-none perspective-1000">
      ...
      <div className="absolute inset-0 pointer-events-none z-0">
        ...
        {/* Abstract floating background particle plates */}
      ...
      >
        ...
        {/* Brand Core Icon Node (Pushed further outward in Z-index space) */}
        <div className="flex flex-col items-center text-center space-y-3 mb-8 translate-z-3d">
          ...
          <div>
            ...
            <p className="text-white/30 text-[9px] font-black tracking-[0.25em] uppercase mt-1">
              3D Matrix Secure Entry Terminal
            </p>
          </div>
        </div>

        {/* MAIN GOOGLE LOGIN CONTROLLER CONTAINER */}
        <div className="space-y-5 translate-z-3d">
          <button
            onClick={() => console.log("Spawning Google Auth Sync...")}
          ...
          >
            ...
            <span>Identity Google Pipeline</span>
          </button>

          {/* ASYMMETRIC METRIC SEPARATOR */}
          ...
          <form onSubmit={handleSubmit} className="space-y-4 text-left">
            ...
            {/* Input Node: Terminal Access Email */}
            <div className="space-y-1.5">
              ...
              <div className="relative flex items-center">
                ...
                <input
                  ...
                  className="w-full bg-white/[0.01] border border-white/10 rounded-xl pl-11 pr-4 py-3.5 text-xs outline-none font-medium placeholder-white/20 transition-all focus:border-lime-400/40 focus:bg-white/[0.04]"
                />
              </div>
            </div>

            {/* Input Node: Secure Token Access Key */}
            <div className="space-y-1.5">
              <div className="flex justify-between items-center">
                <label className="text-[10px] font-black uppercase tracking-widest text-lime-400">Password</label>
                <a href="#" className="text-[10px] text-white/30 hover:text-lime-400 font-bold tracking-wider transition-colors">RESET_KEY?</a>
              </div>
              <div className="relative flex items-center">
                ...
                <input
                  ...
                  onChange={handleInputChange}
                  placeholder="••••••••••••••••"
                  className="w-full bg-white/[0.01] border border-white/10 rounded-xl pl-11 pr-12 py-3.5 text-xs outline-none font-medium placeholder-white/20 transition-all focus:border-lime-400/40 focus:bg-white/[0.04]"
                />
                <button
                  type="button"
            ...
            {/* AUTHORIZATION CORE SUBMIT BUTTON INTERACTIVE NODE */}
            <button
              type="submit"
