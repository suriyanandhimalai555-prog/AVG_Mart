...
import { Calendar, Package, MapPin, Phone, User, Mail, ArrowRight, X, Clock, Truck, CheckCircle2 } from 'lucide-react'
...
const BranchOrders = () => {
  ...
  const handleStatusUpdate = async (e) => {
    ...
    try {
      ...
      toast.error("Network processing fault caught during status update sequence.", { id: transitionToastId })
    }
  }
  ...
  return (
    <div className="p-4 sm:p-6 lg:p-10 space-y-8 bg-royal-dark min-h-screen text-white rounded-2xl">
      <div>
        ...
        <p className="text-xs text-gray-400 mt-1 text-left">
          Modify tracking stages and set regional customer delivery timestamps here.
        </p>
      </div>
          ...
          <div className="bg-royal-dark border border-white/10 w-full max-w-xl rounded-3xl p-6 shadow-2xl relative space-y-6">
            <div className="flex items-center justify-between border-b border-white/10 pb-4">
              <div className="text-left">
                <span className="text-[10px] font-bold uppercase tracking-wider text-emerald-400 font-mono">Branch Operational Matrix</span>
